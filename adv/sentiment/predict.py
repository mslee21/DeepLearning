from batch import getTestBatch
...
if (predictedSentiment[0] > predictedSentiment[1]):
    print(inputText, " : Positive Sentiment")
else:
    print(inputText, " : Negative Sentiment")
...
if (predictedSentiment[0] > predictedSentiment[1]):
    print(secondInputText, " : Positive Sentiment")
else:
    print(secondInputText, " : Negative Sentiment")
